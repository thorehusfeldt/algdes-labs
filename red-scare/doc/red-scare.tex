...
For three of the problems (I’m not telling which), you will not be able to write an algorithm that works for all graphs, because the problems are hard in general.
